...
public class AgendamentoModel {
    ...
    public AgendamentoModel(String id, String codigoConsulta, String codigoPaciente, LocalDateTime data,
                      String especialidade, String medico, double valor, int pontosUsados,
